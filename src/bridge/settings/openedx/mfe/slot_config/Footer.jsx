...
const AutoSelectLanguage = () => {
  ...
  // This API is provided by the ol-openedx-auto-select-language plugin https://github.com/mitodl/open-edx-plugins/tree/main/src/ol_openedx_auto_language_select
