...
let footerLegalLinks = [
  {
    url: `${configData.MARKETING_SITE_BASE_URL}/about`,
    title: 'About Us',
  },
  {
    url: `${configData.MARKETING_SITE_BASE_URL}/privacy`,
    title: 'Privacy Policy',
  },
  {
    url: `${configData.MARKETING_SITE_BASE_URL}/honor`,
    title: 'Honor Code',
  },
  {
    ...
    plugins: [
      { op: PLUGIN_OPERATIONS.Hide, widgetId: 'default_contents' },
      {
        ...
        widget: {
          ...
          type: DIRECT_PLUGIN,
          RenderWidget: () => (
            <CopyrightNotice copyrightText={`© ${currentYear} Massachusetts Institute of Technology`} />
          ),
        },
      },
    ],
