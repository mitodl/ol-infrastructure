...
EBS_CSI_DRIVER_VERSION = "v1.40.0-eksbuild.1"
# renovate: datasource=github-releases depName=aws-efs-csi-driver packageName=kubernetes-sigs/aws-efs-csi-driver
...
VANTAGE_K8S_AGENT_CHART_VERSION = "1.1.0"
