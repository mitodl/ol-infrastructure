...
CONCOURSE_VERSION = "8.2.3"  # (TMM 2026-03-06) - Pin to <8.1.0 because of some login bugs with stale state tokens
...
AWS_LOAD_BALANCER_CONTROLLER_CHART_VERSION = "3.3.0"
...
VANTAGE_K8S_AGENT_CHART_VERSION = "1.6.0"
...
GRAFANA_K8S_MONITORING_CHART_VERSION = "4.1.4"
