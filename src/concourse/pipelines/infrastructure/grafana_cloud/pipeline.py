...
for tool in ["loki", "cortex", "alertmanager"]:
                ...
                TaskStep(
                    ...
                    config=TaskConfig(
                        ...
                        run=Command(
                            ...
                            args=[
                                "-exc",
                                f"cortextool rules lint --backend={tool} {resource_name}/{tool}-rules/*.yaml;",
                            ],
                        ),
                    ),
                ),
    ...
    for stage in ["ci", "qa", "production"]:
        params = {
            ...
            "OPS_TEAM_OPS_GENIE_API_KEY": f"((cortextool.ops-team-ops-genie-api-key))",
            "TESTING_OPS_GENIE_API_KEY": f"((cortextool.testing-ops-genie-api-key))",
