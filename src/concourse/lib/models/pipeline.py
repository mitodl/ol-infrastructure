...
#   filename:  concourse_pipeline_schema.json  # noqa: E800
...
class Value(str):  # noqa: WPS110, WPS600
    pass  # noqa: WPS420, WPS604
...
class Format(str, Enum):  # noqa: WPS600
    """# noqa: D205
        The format of the file's content.    If unset, Concourse will try to detect the format from the file  extension. If the file format cannot be determined, Concourse will  fallback to `trim` .    If set to `json` , `yaml` , or `yml` , the file content  will be parsed accordingly and the resulting structure will be the  value of the var.    If set to `trim` , the var will be set to the content of the file  with any trailing and leading whitespace removed.    If set to `raw` , the var will be set to the content of the file  without modification (i.e. with any existing whitespace).  # noqa: RST201, E501
    @example  Loading a var with multiple fields  # noqa: RST215, RST214
       Let's say we have a file with multiple fields, like this yaml file:      yaml  https://raw.githubusercontent.com/concourse/examples/master/pipelines/vars-file.yml      We could pass these values to subsequent steps by loading it  into a var with `load_var` , which will detect that it is in YAML  format based on the file extension:     ```yaml  # noqa: E501, RST203
    jobs:  # noqa: RST203
    - name: loading-vars  # noqa: RST301
      plan:  # noqa: RST301
      - get: examples
      - load_var: version  # noqa: RST301
        file: examples/pipelines/vars-file.yml  # noqa: RST201
      - put: img  # noqa: RST201
        params:  # noqa: RST301
          version: "((.:version.hello))-((.:version.number))"  # noqa: RST301


    resources:
    - name: examples  # noqa: RST301
      type: git  # noqa: RST301
      icon: github
      source:  # noqa: RST301
        uri: https://github.com/concourse/examples.git  # noqa: RST201
    - name: img  # noqa: RST201
      type: mock  # noqa: RST202, RST214
    ```     If the file `vars-file.yml` was generated in a task and printed  these values, they would be automatically redacted unless    schema.load-var.reveal `reveal: true` is set.  # noqa: E501
    """
...
class Platform(str, Enum):  # noqa: WPS600
    """# noqa: D200
    The platform the task should run on. This determines the pool of workers  that the task can run against.    Technically any string value is allowed so long as a worker advertises the  same platform, but in practice only `linux` , `darwin` , and   `windows` are in use.  # noqa: E501
    """
...
class Vars(BaseModel):  # noqa: WPS110
    pass  # noqa: WPS420, WPS604
...
class DummyConfig(BaseModel):
    ...
    vars: Optional[Vars] = Field(  # noqa: WPS110
...
class PutStep(Step):
    ...
    params: Optional[dict[str, Any]] = Field(  # noqa: WPS110
        None,
        description=(
...
class AcrossVar(BaseModel):
    ...
    var: Optional[Identifier] = Field(  # noqa: WPS110
        None,
        description=(
    ...
    values: Optional[list[Value]] = Field(  # noqa: WPS110
        None,
        description=(
    ...
    max_in_flight: Optional[Union[Literal["all"], Number]] = Field(  # noqa: WPS234
        None,
        description=(
...
class SetPipelineStep(Step):
    ...
    set_pipeline: Optional[Union[Identifier, Literal["self"]]] = Field(  # noqa: WPS234
        None,
        description=(
    ...
    file: Optional[str] = Field(  # noqa: WPS110
        None,
        description=(
...
class Resource(BaseModel):
    ...
    check_every: Optional[Union[Duration, Literal["never"]]] = Field(  # noqa: WPS234
        None,
        description=(
...
class GetStep(Step):
    ...
    version: Optional[  # noqa: WPS234
        Union[Literal["latest"], Literal["every"], Version]
    ] = Field(
        None,
        description=(
...
class TaskConfig(BaseModel):
    ...
    params: Optional[dict[str, Optional[str]]] = Field(  # noqa: WPS110, WPS234
        None,
        description=(
...
class InParallelStep(Step):
    ...
    in_parallel: Optional[Union[list[Step], InParallelConfig]] = Field(  # noqa: WPS234
        None,
        description=(
...
class DoStep(Step):
    ...
    do: Optional[list[Step]] = Field(  # noqa: WPS110
        None,
        description=(
