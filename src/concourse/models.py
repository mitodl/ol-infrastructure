...
class Concourse(BaseModel):
    class Config:
        extra = Extra.allow

    __root__: Pipeline = Field(
        ...,
        ...
        definitions={
                ...
                "properties": {
                    "in_parallel": {
                        "description": (
                            ...
                            " the `in_parallel` fails, the build will fail, making it "
                            " useful for build matrices:     ```yaml\nplan:\n- get:"
                            " some-repo\n- in_parallel:\n  - task: unit-windows\n   "
                        ...
                        "oneOf": [
                            {
                                "type": "array",
                                "items": {"oneOf": [{"$ref": "#/definitions/step"}]},
                            },
            ...
            "vault_var_source": {
                ...
                "properties": {
                    ...
                    "config": {
                        ...
                        "oneOf": [{"$ref": "#/definitions/vault_config"}],
                    },
                },
            },
                ...
                "properties": {
                    ...
                    "old_name": {
                        "description": (
                            ...
                            " like so:     ```yaml\njobs:\n- name: new-name\n "
                            " old_name: current-name\n  plan: [{get: 10m}]\n```    "
                            " After the pipeline is set, because the builds have been"
                            " inherited, the job can  have the field removed:    "
                            " ```yaml\njobs:\n- name: new-name\n  plan: [{get:"
                            " 10m}]\n```"
                        ),
                        "oneOf": [{"$ref": "#/definitions/identifier"}],
                    },
                    "on_success": {
                        "description": (
                    ...
                    "serial_groups": {
                        "description": (
                            ...
                            " `job-c` can run concurrently, but  neither job can run"
                            " builds at the same time as `job-b` .    The builds are"
                            " executed in their order of creation, across all jobs with"
                            "  common tags."
                        ),
                        "oneOf": [
                            {
                    ...
                    "build_log_retention": {
                        "description": (
                            ...
                            " task: smoke-tests\n    # ...\n```     If more than 1000"
                            " builds finish in the past 2 days,  all  of them  will be"
                            " retained thanks to the   "
                        ...
                        "oneOf": [{"$ref": "#/definitions/build_log_retention_policy"}],
                    },
                    "name": {
                        "description": (
                ...
                "properties": {
                    "jobs": {
                        ...
                        "oneOf": [
                            {
                                "type": "array",
                                "items": {"oneOf": [{"$ref": "#/definitions/job"}]},
                            }
                        ],
                    },
                    "groups": {
                        "description": (
                            ...
                            " jobs:\n  - unit\n  - integration\n- name: publish\n "
                            " jobs:\n  - deploy\n  - shipit\n```     This would display"
                            ' two tabs at the top of the home page: "test" and '
                            ' "publish".    For a real world example of how groups can'
                            " be used to simplify navigation  and provide logical"
                            " grouping, see the groups used at the top of the page  in"
                            " the  Concourse pipeline  https://ci.concourse-ci.org  .  "
                            "        group_config      name  identifier    A unique"
                            " name for the group. This should be short and simple as it"
                            " will  be used as the tab name for navigation.         "
                            " jobs  [job.name]    A list of jobs that should appear in"
                            " this group. A job may  appear in multiple groups."
                            " Neighbours of jobs in the current group will also  appear"
                            " on the same page in order to give context of the location"
                            " of the  group in the pipeline.    You may also use any"
                            " valid  glob "
                            " https://www.man7.org/linux/man-pages/man7/glob.7.html   "
                            " to represent several jobs, e.g.:     ```yaml\ngroups:\n-"
                            " name: develop\n  jobs:\n  - terraform-*\n  - test\n  -"
                            " deploy-{dev,staging}\n- name: ship\n  jobs:\n  -"
                            ' deploy-prod\n- name: all\n  jobs:\n  - "*"\n```     In'
                            " this example, the `develop` group will match  "
                        ...
                        "oneOf": [
                            {
                                "type": "array",
                                "items": {
                                    "oneOf": [{"$ref": "#/definitions/group_config"}]
                                },
                            }
                        ],
                    },
                        ...
                        "oneOf": [
                            {
                                "type": "array",
                                "items": {
                                    "oneOf": [{"$ref": "#/definitions/resource_type"}]
                                },
                            }
                        ],
                    },
                        ...
                        "oneOf": [
                            {
                                "type": "array",
                                "items": {
                                    "oneOf": [{"$ref": "#/definitions/var_source"}]
                                },
                            }
                        ],
                    },
                    "display": {
                        "description": (
                            ...
                            " it is configured on.     ```yaml\ndisplay:\n "
                            " background_image:"
                            " https://avatars1.githubusercontent.com/u/7809479?s=400&v=4\n```"
                            "           display_config      background_image  string   "
                            " Allow users to specify a custom background image which is"
                            " put at 30%  opacity, grayscaled and blended into existing"
                            " background. Must be an  http, https, or relative URL."
                        ),
                        "oneOf": [{"$ref": "#/definitions/display_config"}],
                    },
                    "resources": {
                        "description": (
                ...
                "properties": {
                    "try": {
                        "description": (
                            ...
                            " to just swallow the  error:     ```yaml\nplan:\n- task:"
                            " run-tests\n  config: # ...\n  on_success:\n    try:\n    "
                            "  put: test-logs\n      params:\n        from:"
            ...
            "output": {
                ...
                "properties": {
                    "path": {
                        ...
                        "oneOf": [{"$ref": "#/definitions/dir_path"}],
                    },
                    "name": {
                        "description": (
                ...
                "properties": {
                    ...
                    "max_in_flight": {
                        "description": (
                            ...
                            " var2\n    values: [1, 2]\n  - var: var3\n    values:"
                            " [foo, bar]\n    max_in_flight: 2\n```     Here, ** 6"
                            " substeps ** will run in parallel, since all 3 of   `var1`"
                            " 's values can run in parallel, and 2 of `var3` 's  values"
                            " can run in parallel."
                        ),
                        "oneOf": [
            ...
            "dummy_var_source": {
                ...
                "properties": {
                    "config": {
                        ...
                        "oneOf": [{"$ref": "#/definitions/dummy_config"}],
                    },
                    "type": {
                        "description": (
            ...
            "vault_config": {
                ...
                "properties": {
                    ...
                    "auth_retry_max": {
                        ...
                        "oneOf": [{"$ref": "#/definitions/duration"}],
                    },
                    "url": {
                    ...
                    "lookup_templates": {
                        ...
                        "oneOf": [
                            {
                                "type": "array",
                                "items": {"oneOf": [{"$ref": "#/definitions/string"}]},
                            }
                        ],
                    },
                    "ca_cert": {
                ...
                "properties": {
                    "set_pipeline": {
                        "description": (
                            ...
                            " run    fly-set-pipeline  .     ```yaml\njobs:\n- name:"
                            " set-pipeline\n  plan:\n  - get: examples\n    trigger:"
                            " true\n  - set_pipeline: hello-world  # pipeline's name\n "
                            "   file: examples/pipelines/hello-world.yml  # pipeline's"
                            " config\n\nresources:\n- name: examples\n  type: git\n "
                            " icon: github\n  source:\n    uri:"
                            " https://github.com/concourse/examples.git\n```"
                        ),
                        ...
                        "oneOf": [
                            {
                                "type": "array",
                                "items": {
                                    "oneOf": [{"$ref": "#/definitions/file_path"}]
                                },
                            }
                        ],
                    },
                    "file": {
                        "description": (
                            ...
                            " using a    set-pipeline-step  :     ```yaml\njobs:\n-"
                            " name: set-pipeline\n  plan:\n  - get: examples\n   "
                            " trigger: true\n  - set_pipeline: hello-world  #"
                            " pipeline's name\n    file:"
                            " examples/pipelines/hello-world.yml  # pipeline's"
                            " config\n\nresources:\n- name: examples\n  type: git\n "
                            " icon: github\n  source:\n    uri:"
                            " https://github.com/concourse/examples.git\n```"
                        ),
                    ...
                    "instance_vars": {
                        "description": (
                            ...
                            " pipelines in the instance group.   ```yaml\njobs:\n-"
                            " name: set-pipeline-instance-group\n  plan:\n  - get:"
                            " examples\n  - in_parallel:\n    - set_pipeline: my-bots\n"
                            "      file: examples/pipelines/pipeline-vars.yml\n     "
                            " instance_vars:\n        first: initial\n        number:"
            ...
            "cache": {
                ...
                "properties": {
                    "path": {
                        "description": (
                            "The path to a directory to be cached.    Paths are"
                            " relative to the working directory of the task. Absolute"
                            " paths  are not respected."
                        ),
                        "oneOf": [{"$ref": "#/definitions/dir_path"}],
                    }
                },
                ...
                "properties": {
                    "format": {
                        "description": (
                            ...
                            " name: examples\n  type: git\n  icon: github\n  source:\n "
                            "   uri: https://github.com/concourse/examples.git\n- name:"
                            " img\n  type: mock\n```     If the file `vars-file.yml`"
                            " was generated in a task and printed  these values, they"
                            " would be automatically redacted unless   "
                            " schema.load-var.reveal `reveal: true` is set."
                        ),
                        "type": "string",
                ...
                "properties": {
                    ...
                    "old_name": {
                        "description": (
                            ...
                            " current-name\n  type: git\n  source: {uri:"
                            ' "https://github.com/vito/booklit"}\n```     After the'
                            " pipeline is set, the resource was successfully renamed,"
                            " so the `old_name` field can  be removed from the"
                            " resource:     ```yaml\nresources:\n- name: new-name\n "
                            " type: git\n  source: {uri:"
                            ' "https://github.com/vito/booklit"}\n```'
                        ),
            ...
            "task_config": {
                ...
                "properties": {
                    "image_resource": {
                        ...
                        "oneOf": [{"$ref": "#/definitions/anonymous_resource"}],
                    },
                    "caches": {
                        "description": (
                        ...
                        "oneOf": [
                            {
                                "type": "array",
                                "items": {"oneOf": [{"$ref": "#/definitions/cache"}]},
                            }
                        ],
                    },
                    "run": {
                    ...
                    "inputs": {
                        ...
                        "oneOf": [
                            {
                                "type": "array",
                                "items": {"oneOf": [{"$ref": "#/definitions/input"}]},
                            }
                        ],
                    },
                    "platform": {
                    ...
                    "params": {
                        ...
                        "oneOf": [{"$ref": "#/definitions/env_vars"}],
                    },
                    "container_limits": {
                        "description": (
                            ...
                            " container then the number of CPU time per  container"
                            " changes. CPU shares are relative to each other.  "
                            " ```\nContainer A: 2 shares - 25% CPU\nContainer B: 2"
                            " shares - 25% CPU\nContainer C: 4 shares - 50% CPU\nTotal"
                            " CPU shares declared: 8\n```           memory  number   "
                            " The maximum amount of memory available to the task"
                            " container, measured in  bytes. 0 means unlimited."
                        ),
                        "oneOf": [{"$ref": "#/definitions/container_limits"}],
                    },
                    "outputs": {
                        "description": (
                        ...
                        "oneOf": [
                            {
                                "type": "array",
                                "items": {"oneOf": [{"$ref": "#/definitions/output"}]},
                            }
                        ],
                    },
                    "rootfs_uri": {
                ...
                "properties": {
                    "cpu": {
                        "description": (
                            ...
                            " of the CPU's time.     ```\nContainer A: 2 shares - 50%"
                            " CPU\nContainer B: 2 shares - 50% CPU\nTotal CPU shares"
                            " declared: 4\n```     If you introduce another container"
                            " then the number of CPU time per  container changes. CPU"
                            " shares are relative to each other.   ```\nContainer A: 2"
                ...
                "properties": {
                    ...
                    "defaults": {
                        "description": (
                            ...
                            " overwrite the base resource types, it can be  used to"
                            " give defaults to resources at the pipeline level.    "
                            " ```yaml\nresource_types:\n- name: registry-image\n  type:"
                            " registry-image\n  source:\n    repository:"
                            " concourse/registry-image-resource\n  defaults:\n   "
                            " registry_mirror:\n      host:"
                            ...
                            " node can be configured to use    resource-defaults "
                ...
                "properties": {
                    ...
                    "passed": {
                        "description": (
                            ...
                            " initial_version: tower\n- name: cyberdeck\n  type: mock\n"
                            "  source:\n    initial_version: mk3\n```     For the final"
                            " job, `lvl-3-production` , only versions that have  passed"
                            " the previous two jobs ( `lvl-2-unit` and  "
                    ...
                    "trigger": {
                        "description": (
                            ...
                            " trigger job on new versions \n      ```yaml\njobs:\n-"
                            " name: fetch-repo\n  plan:\n  - get: repo\n    trigger:"
                            " true # automatically runs the job\n  - task: ls-repo\n   "
                            " config:\n      platform: linux\n      image_resource:\n  "
                            "      type: mock\n        source: {mirror_self: true}\n   "
                            "   inputs:\n      - name: repo\n      run:\n        path:"
                            ' ls\n        args: ["-lah","repo"]\n\nresources:\n- name:'
                    ...
                    "get": {
                        "description": (
                            ...
                            " task-step  .     ```yaml\njobs:\n- name: fetch-repo\n "
                            " plan:\n  - get: repo # fetches repo under artifact name"
                            ' "repo"\n  - task: ls-repo\n    config:\n      platform:'
                            " linux\n      image_resource:\n        type: mock\n       "
                            ' source: {mirror_self: true}\n      # pass the "repo"'
                            " artifact into the task\n      inputs:\n      - name:"
                    ...
                    "resource": {
                        "description": (
                            ...
                            " \n@example  Re-labelling artifact \n    ```yaml\njobs:\n-"
                            " name: fetch-repo\n  plan:\n  - get: thecode # fetches"
                            ' "repo" under artifact name "thecode"\n    resource:'
                            " repo\n  - task: ls-repo\n    config:\n      platform:"
                            " linux\n      image_resource:\n        type: mock\n       "
                            ' source: {mirror_self: true}\n      # pass the "thecode"'
                            " artifact into the task\n      inputs:\n      - name:"
                ...
                "properties": {
                    "config": {
                        "description": (
                            ...
                            " config \n    ```yaml\njobs:\n- name: job\n  public:"
                            " true\n  plan:\n  - task: simple-task\n    config: #"
                            " contains all field in a task config\n      platform:"
                            " linux\n      image_resource:\n        type:"
                            " registry-image\n        source: { repository: busybox }\n"
                            '      run:\n        path: echo\n        args: ["Hello'
                            ' world!"]\n```'
                        ),
                        "oneOf": [{"$ref": "#/definitions/task_config"}],
                    },
                    "file": {
                        "description": (
                    ...
                    "params": {
                        "description": (
                            ...
                            " task with values passed in like so:     ```yaml\njobs:\n-"
                            " name: task-params\n  plan:\n  - get: ci\n  - task:"
                            " constrained-task\n    file: ci/tasks/print-param.yml\n   "
                            ' params:\n      ECHO_ME: "Eat your fruits"\n      ALSO_ME:'
                            ' "veggies"\n\nresources:\n- name: ci\n  type: git\n '
                    ...
                    "vars": {
                        "description": (
                            ...
                            " like so:     ```yaml\njobs:\n- name: task-vars\n  plan:\n"
                            "  - get: ci\n  - task: override-task-vars\n    file:"
                            " ci/tasks/print-var.yml\n    vars: # statically defined"
                            ' vars\n      my-var: "Cookies are the best"\n     '
                            ' second-var: "chips are a close second"\n\nresources:\n-'
                            " name: ci\n  type: git\n  source:\n    uri:"
                            " https://github.com/concourse/examples.git\n```     When"
                            " run with the following  tasks  task config  :      yaml "
                            " https://raw.githubusercontent.com/concourse/examples/master/tasks/print-var.yml"
                    ...
                    "container_limits": {
                        "description": (
                            ...
                            " shares - 25% CPU\nContainer B: 2 shares - 25%"
                            " CPU\nContainer C: 4 shares - 50% CPU\nTotal CPU shares"
                            " declared: 8\n```           memory  number    The maximum"
                            " amount of memory available to the task container,"
                            " measured in  bytes. 0 means unlimited.         \n@example"
                            "  Setting CPU and Memory limits \n   This task will only"
                            " be given 10MB of memory and 2 CPU shares.    "
                            " ```yaml\njobs:\n- name: limited-resources\n  plan:\n  -"
                            " task: constrained-task\n    container_limits:\n      cpu:"
                            " 2 # CPU shares are relative\n      memory: 10000000 #"
                            " 10MB\n    config:\n      platform: linux\n     "
                            " image_resource:\n        type: registry-image\n       "
                            " source: { repository: busybox }\n      run:\n       "
                            ' path: echo\n        args: ["Hello world!"]\n```'
                ...
                "properties": {
                    "resource": {
                        "description": (
                            ...
                            " platform: linux\n      image_resource:\n        type:"
                            " mock\n        source: {mirror_self: true}\n      # pass"
                            ' the "thecode" artifact into the task\n      inputs:\n    '
                            "  - name: thecode\n      run:\n        path: ls\n       "
                            ' args: ["-lah","thecode"]\n\nresources:\n- name: repo\n '
                            " type: mock\n```"
                        ),
                    ...
                    "inputs": {
                        "description": (
                            ...
                            " artifact\n    params:\n      file: ci/version.txt\n  -"
                            " put: explicit-inputs\n    resource: repo\n    inputs: #"
                            " explicitly list artifacts to stream to put step\n      -"
                            " ci\n    params:\n      file:"
                            " ci/version.txt\n\nresources:\n- name: repo\n  type:"
                            " mock\n- name: repo-dev\n  type: mock\n- name:"
                            " repo-master\n  type: mock\n- name: app-image\n  type:"
