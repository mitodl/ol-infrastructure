...
def build_meta_job(release_name):
    if release_name == "meta":
        ...
        pipeline_definition_path = (
            "src/ol_concourse/pipelines/open_edx/xqwatcher/pipeline.py"
        )
...
if __name__ == "__main__":
    ...
    pipeline_json = pipeline_json_with_user_data(
        ...
        user_data={
            "description": (
                "Regenerates and applies the per-release xqwatcher pipelines "
                "(`docker-pulumi-xqwatcher-{release}`) for every "
