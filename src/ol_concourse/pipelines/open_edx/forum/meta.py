...
pipeline_code = git_repo(
    ...
    paths=[
        ...
        "src/ol_concourse/pipelines/open_edx/forum/",
    ],
)
...
def build_meta_job(release_name):
    if release_name == "meta":
        pipeline_definition_path = "src/ol_concourse/pipelines/open_edx/forum/meta.py"
        pipeline_team = "main"
        pipeline_id = "self"
    else:
        pipeline_definition_path = "src/ol_concourse/pipelines/open_edx/forum/docker_packer_pulumi_pipeline.py"  # noqa: E501
...
if __name__ == "__main__":
    ...
    sys.stdout.write(
        "\nfly -t <target> set-pipeline -p docker-packer-pulumi-forum-meta -c definition.json"  # noqa: E501
    )
