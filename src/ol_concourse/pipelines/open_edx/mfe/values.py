...
mitxonline = [
    OpenEdxVars(
        ...
        contact_url="https://support.learn.mit.edu/",
        ...
        lms_domain="courses.ci.learn.mit.edu",
        logo_url="https://courses.ci.learn.mit.edu/static/mitxonline/images/logo.svg",
        marketing_site_domain="ci.mitxonline.mit.edu",
        mit_base_url="https://web.mit.edu",
        mit_learn_base_url="https://ci.learn.mit.edu",
        mit_learn_api_url="https://api.ci.learn.mit.edu",
        feedback_csrf_cookie_name="learn_ci_csrftoken",
        privacy_policy_url="https://ci.mitxonline.mit.edu/privacy-policy/",
        schedule_email_section="true",  # Because the communication MFE treats this boolean as string  # noqa: E501
        site_name="MIT Learn CI",
        studio_domain="studio.courses.ci.learn.mit.edu",
        support_url="https://support.learn.mit.edu/",
        terms_of_service_url="https://ci.mitxonline.mit.edu/terms-of-service/",
        trademark_text="© MIT Open Learning. All rights reserved except where noted.",
    ...
    OpenEdxVars(
        ...
        environment_stage="QA",
        enable_certificate_page="false",
        favicon_url="https://courses.rc.learn.mit.edu/static/mitxonline/images/favicon.ico",
        honor_code_url="https://rc.mitxonline.mit.edu/honor-code/",
        lms_domain="courses.rc.learn.mit.edu",
        logo_url="https://courses.rc.learn.mit.edu/static/mitxonline/images/logo.svg",
        marketing_site_domain="rc.mitxonline.mit.edu",
        mit_base_url="https://web.mit.edu",
        mit_learn_base_url="https://rc.learn.mit.edu",
        mit_learn_api_url="https://api.rc.learn.mit.edu",
        feedback_csrf_cookie_name="learn_rc_csrftoken",
        privacy_policy_url="https://rc.mitxonline.mit.edu/privacy-policy/",
        schedule_email_section="true",  # Because the communication MFE treats this boolean as string  # noqa: E501
        site_name="MIT Learn QA",
        studio_domain="studio.courses.rc.learn.mit.edu",
        support_url="https://support.learn.mit.edu/",
    ...
    OpenEdxVars(
        ...
        environment_stage="Production",
        enable_certificate_page="false",
        favicon_url="https://courses.learn.mit.edu/static/mitxonline/images/favicon.ico",
        honor_code_url="https://mitxonline.mit.edu/honor-code/",
        lms_domain="courses.learn.mit.edu",
        logo_url="https://courses.learn.mit.edu/static/mitxonline/images/logo.svg",
        marketing_site_domain="mitxonline.mit.edu",
        mit_base_url="https://web.mit.edu",
        mit_learn_base_url="https://learn.mit.edu",
        mit_learn_api_url="https://api.learn.mit.edu",
        feedback_csrf_cookie_name="learn_csrftoken",
        privacy_policy_url="https://mitxonline.mit.edu/privacy-policy/",
        schedule_email_section="true",  # Because the communication MFE treats this boolean as string  # noqa: E501
        site_name="MIT Learn",
        studio_domain="studio.courses.learn.mit.edu",
        support_url="https://support.learn.mit.edu/",
