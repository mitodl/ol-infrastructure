...
if __name__ == "__main__":
    ...
    output = pipeline_json_with_user_data(
        ...
        user_data={
            "description": (
                "Publishes every package discovered in the `mitodl/ol-django` "
                "monorepo to PyPI: for each package, validates `changelog.d/` "
                "entries exist, bumps the version, merges the changelog, "
                "commits and tags `<package>/v<version>`, and pushes -- which "
                "triggers GitHub Actions to build and publish. Generated by "
                "`publish-python-packages-meta`, not run standalone."
            ),
            "team": "main",
