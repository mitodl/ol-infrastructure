    ...
    apisix_helm_release = kubernetes.helm.v3.Release(
        ...
        kubernetes.helm.v3.ReleaseArgs(
            ...
            values={
                ...
                "dataPlane": {
                    "enabled": True,
                    "useDaemonSet": True,  # Use DaemonSet as per original config
                    "tolerations": operations_tolerations,
                    "resources": {
                        "requests": {
                            "cpu": "100m",
                    ...
                    "tls": {
                        "enabled": False,  # Disable chart's internal TLS handling for the service
                        "autoGenerated": False,  # cert-manager will handle TLS for routes/domains
                    },
                    "service": {
                        "type": "LoadBalancer",
                        "annotations": {
                        ...
                        # Ports are defined under dataPlane.containerPorts and exposed via service ports
                        # Default ports 80/443 seem correct based on Bitnami values
                    },
                    # Map nginx config snippets and logs
                    "extraConfig": {
                        "apisix": {
                            "nginx_config": {
                                "main": {
