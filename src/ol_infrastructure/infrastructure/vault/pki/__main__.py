...
for business_unit in BusinessUnit:
    ...
    export("pki_intermediate_env", pki_intermediate_env.name)
    export("pki_fluentd_server_role", pki_fluentd_server_role.name)
    export("pki_fluentd_client_role", pki_fluentd_client_role.name)
