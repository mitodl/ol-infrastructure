...
class InstanceTypes(StrEnum):
    ...
    general_purpose_intel_flex_large = "m8i-flex.large"
    general_purpose_intel_flex_xlarge = "m8i-flex.xlarge"
    general_purpose_intel_flex_2xlarge = "m8i-flex.2xlarge"
    general_purpose_intel_flex_4xlarge = "m8i-flex.4xlarge"
    compute_intel_flex_xlarge = "c8i-flex.xlarge"
