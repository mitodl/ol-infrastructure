...
from bridge.lib.constants import FASTLY_CNAME_TLS_1_3
...
mitlearn_fastly = OLFastlyServiceVCL(
    f"fastly-{stack_info.env_prefix}-{stack_info.env_suffix}",
    config=OLFastlyServiceVCLConfig(
        service_name=f"MIT Learn {stack_info.env_suffix}",
        service_vcl_resource_name=f"fastly-{stack_info.env_prefix}-{stack_info.env_suffix}",
        backends=[
        ...
        dictionaries=[
            fastly.ServiceVclDictionaryArgs(name="path_redirects"),
            fastly.ServiceVclDictionaryArgs(name="prefix_redirects"),
        ],
        domains=[
        ...
        dns=OLFastlyServiceVCLDNSConfig(
            frontend_domain=learn_frontend_domain,
...
mitlearn_fastly_service = mitlearn_fastly.service
