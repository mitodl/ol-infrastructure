        ...
        config.update(
            {
                ...
                "MITOL_ENROLLMENT_WEBHOOK_URL": f"https://{marketing_domain}/api/openedx_webhook/enrollment/",
                "MITOL_CERTIFICATE_WEBHOOK_URL": f"https://{marketing_domain}/api/openedx_webhook/certificate/",
