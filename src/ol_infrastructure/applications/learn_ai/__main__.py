...
learn_ai_fastly = OLFastlyServiceVCL(
    f"learn-ai-{stack_info.env_suffix}",
    config=OLFastlyServiceVCLConfig(
        service_name=f"Learn AI {stack_info.env_suffix}",
        service_vcl_resource_name=f"learn-ai-fastly-service-{stack_info.env_suffix}",
        domains=[
        ...
        dns=OLFastlyServiceVCLDNSConfig(
            frontend_domain=learn_ai_frontend_domain,
            zone_id=ol_zone_id,
        ),
    ),
    opts=fastly_provider,
)
learn_ai_fastly_service = learn_ai_fastly.service
