...
for purpose in ("draft", "live", "test"):
    ...
    robots_error_handler_vcl = (
        ...
        .read_text()
        .replace("ROBOTS_CONTENT_PLACEHOLDER", robots_content_escaped)
    )
    ...
    servicevcl_backend = fastly.ServiceVcl(
        ...
        snippets=[
            ...
            fastly.ServiceVclSnippetArgs(
                content=snippets_dir.joinpath("robots_txt_handler.vcl").read_text(),
            ...
            fastly.ServiceVclSnippetArgs(
                content=robots_error_handler_vcl,
                name="Robots.txt Error Handler",
                type="error",
            ),
            fastly.ServiceVclSnippetArgs(
                content=snippets_dir.joinpath(
