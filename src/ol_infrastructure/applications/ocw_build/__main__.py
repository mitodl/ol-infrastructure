...
This will run the ocw-to-hugo and hugo-course-publisher applications, and will
push web content to the OCW site's S3 buckets.
...
- Register a minion ID and key pair with the appropriate SaltStack master
  instance
...
aws_config = AWSBase(
    tags={
        'OU': 'open-courseware',
        'Environment': ocw_next_build_environment
    },
)
