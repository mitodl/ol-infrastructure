    ...
    mitxonline_secrets_configs: list[dict[str, Any]] = [
        {
            ...
            "templates": {
                ...
                "OPENEDX_RETIREMENT_SERVICE_WORKER_CLIENT_ID": '{{ index .Secrets "open-edx-retirement-service-worker" "client_id" }}',
                "OPENEDX_RETIREMENT_SERVICE_WORKER_CLIENT_SECRET": '{{ index .Secrets "open-edx-retirement-service-worker" "client_secret" }}',
