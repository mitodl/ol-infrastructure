...
def get_catalog(created_at: Optional[Mapping[str, _builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('rootly:index/getCatalog:getCatalog', __args__, opts=opts, typ=GetCatalogResult, package_ref=_utilities.get_package()).value

    return AwaitableGetCatalogResult(
        created_at=pulumi.get(__ret__, 'created_at'),
        id=pulumi.get(__ret__, 'id'),
        name=pulumi.get(__ret__, 'name'))
def get_catalog_output(created_at: pulumi.Input[Optional[Optional[Mapping[str, _builtins.str]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('rootly:index/getCatalog:getCatalog', __args__, opts=opts, typ=GetCatalogResult, package_ref=_utilities.get_package())
