...
def get_heartbeat(created_at: Optional[Mapping[str, _builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('rootly:index/getHeartbeat:getHeartbeat', __args__, opts=opts, typ=GetHeartbeatResult, package_ref=_utilities.get_package()).value

    return AwaitableGetHeartbeatResult(
        created_at=pulumi.get(__ret__, 'created_at'),
        id=pulumi.get(__ret__, 'id'),
        name=pulumi.get(__ret__, 'name'))
def get_heartbeat_output(created_at: pulumi.Input[Optional[Optional[Mapping[str, _builtins.str]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('rootly:index/getHeartbeat:getHeartbeat', __args__, opts=opts, typ=GetHeartbeatResult, package_ref=_utilities.get_package())
