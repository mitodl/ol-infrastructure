...
class WorkflowTaskUpdateNotionPageArgs:
    def __init__(__self__, *,
        ...
        if workflow_task_update_notion_page_id is not None:
            pulumi.set(__self__, "workflow_task_update_notion_page_id", workflow_task_update_notion_page_id)
...
@pulumi.type_token("rootly:index/workflowTaskUpdateNotionPage:WorkflowTaskUpdateNotionPage")
class WorkflowTaskUpdateNotionPage(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["workflow_task_update_notion_page_id"] = workflow_task_update_notion_page_id
