...
class WorkflowSimpleArgs:
    def __init__(__self__, *,
                 ...
                 trigger_params: pulumi.Input[Optional['WorkflowSimpleTriggerParamsArgs']] = None,
                 wait: pulumi.Input[Optional[_builtins.str]] = None,
                 workflow_group_id: pulumi.Input[Optional[_builtins.str]] = None,
                 workflow_simple_id: pulumi.Input[Optional[_builtins.str]] = None):
        """
        ...
        if workflow_simple_id is not None:
            pulumi.set(__self__, "workflow_simple_id", workflow_simple_id)
    ...
    def trigger_params(self) -> pulumi.Input[Optional['WorkflowSimpleTriggerParamsArgs']]:
        return pulumi.get(self, "trigger_params")

    @trigger_params.setter
    def trigger_params(self, value: pulumi.Input[Optional['WorkflowSimpleTriggerParamsArgs']]):
    ...
    def workflow_simple_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        return pulumi.get(self, "workflow_simple_id")

    @workflow_simple_id.setter
    def workflow_simple_id(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "workflow_simple_id", value)
...
@pulumi.type_token("rootly:index/workflowSimple:WorkflowSimple")
class WorkflowSimple(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 slug: pulumi.Input[Optional[_builtins.str]] = None,
                 sub_status_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 trigger_params: pulumi.Input[Optional[Union['WorkflowSimpleTriggerParamsArgs', 'WorkflowSimpleTriggerParamsArgsDict']]] = None,
                 wait: pulumi.Input[Optional[_builtins.str]] = None,
                 workflow_group_id: pulumi.Input[Optional[_builtins.str]] = None,
                 workflow_simple_id: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["workflow_simple_id"] = workflow_simple_id
    ...
    def get(resource_name: str,
            ...
            wait: pulumi.Input[Optional[_builtins.str]] = None,
            workflow_group_id: pulumi.Input[Optional[_builtins.str]] = None,
            workflow_simple_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'WorkflowSimple':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="triggerParams")
    def trigger_params(self) -> pulumi.Output[Optional['outputs.WorkflowSimpleTriggerParams']]:
        return pulumi.get(self, "trigger_params")
