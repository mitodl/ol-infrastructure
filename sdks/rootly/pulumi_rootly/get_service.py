...
class GetServiceResult:
    ...
    """
    def __init__(__self__, alert_broadcast_enabled=None, backstage_id=None, cortex_id=None, created_at=None, external_id=None, id=None, incident_broadcast_enabled=None, name=None, slug=None):
...
def get_service(alert_broadcast_enabled: Optional[_builtins.bool] = None,
    ...
    __ret__ = pulumi.runtime.invoke('rootly:index/getService:getService', __args__, opts=opts, typ=GetServiceResult, package_ref=_utilities.get_package()).value
...
def get_service_output(alert_broadcast_enabled: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('rootly:index/getService:getService', __args__, opts=opts, typ=GetServiceResult, package_ref=_utilities.get_package())
