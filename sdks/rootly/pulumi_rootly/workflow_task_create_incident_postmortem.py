...
class WorkflowTaskCreateIncidentPostmortemArgs:
    def __init__(__self__, *,
        ...
        if workflow_task_create_incident_postmortem_id is not None:
            pulumi.set(__self__, "workflow_task_create_incident_postmortem_id", workflow_task_create_incident_postmortem_id)
...
@pulumi.type_token("rootly:index/workflowTaskCreateIncidentPostmortem:WorkflowTaskCreateIncidentPostmortem")
class WorkflowTaskCreateIncidentPostmortem(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["workflow_task_create_incident_postmortem_id"] = workflow_task_create_incident_postmortem_id
