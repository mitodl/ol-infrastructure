...
def get_environment(color: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('rootly:index/getEnvironment:getEnvironment', __args__, opts=opts, typ=GetEnvironmentResult, package_ref=_utilities.get_package()).value
...
def get_environment_output(color: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('rootly:index/getEnvironment:getEnvironment', __args__, opts=opts, typ=GetEnvironmentResult, package_ref=_utilities.get_package())
