...
class WorkflowTaskCreateJiraIssueArgs:
    def __init__(__self__, *,
        ...
        if workflow_task_create_jira_issue_id is not None:
            pulumi.set(__self__, "workflow_task_create_jira_issue_id", workflow_task_create_jira_issue_id)
...
@pulumi.type_token("rootly:index/workflowTaskCreateJiraIssue:WorkflowTaskCreateJiraIssue")
class WorkflowTaskCreateJiraIssue(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["workflow_task_create_jira_issue_id"] = workflow_task_create_jira_issue_id
