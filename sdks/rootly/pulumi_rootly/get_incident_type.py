...
def get_incident_type(color: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('rootly:index/getIncidentType:getIncidentType', __args__, opts=opts, typ=GetIncidentTypeResult, package_ref=_utilities.get_package()).value
...
def get_incident_type_output(color: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('rootly:index/getIncidentType:getIncidentType', __args__, opts=opts, typ=GetIncidentTypeResult, package_ref=_utilities.get_package())
