...
def get_logger_config(
    log_dir,  # lint-amnesty, pylint: disable=unused-argument
    logging_env="no_env",
    local_loglevel="INFO",
    service_variant="",
):
    ...
    logger_config = {
        ...
        "loggers": {
            ...
            "": {"handlers": ["console", "local"], "level": "INFO", "propagate": False},
            "django.request": {
...
def log_python_warnings():
    ...
    warnings.filterwarnings(
        "ignore", "Setting _field_data via the constructor is deprecated"
    )
